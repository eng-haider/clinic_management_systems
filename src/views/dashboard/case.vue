        ...
        <v-card-text>
          <v-container>
            <div class="patiant_status">
              <v-chip class="ma-2" color="primary"> اختر السن : </v-chip>
              <v-radio-group
                style="float: left"
                row
              ...
              <div v-if="editedItem.id !== undefined && editedItem.id < 87">
                <v-layout row wrap dense>
                  <v-flex xs1 md2 class="d-none d-sm-flex"> </v-flex>
                  <v-flex xs6 md4>
                    <v-text-field
                      type="number"
                      v-model="editedItem.upper_right"
                      filled
                      label="العلوي الايمين"
                    ></v-text-field>
                  </v-flex>
                  <v-flex
                    xs6
                ...
                <v-layout row wrap dense>
                  ...
                  <v-flex xs6 md4>
                    <v-text-field
                      v-model="editedItem.lower_right"
                      type="number"
                      dense
                      filled
              ...
              <v-row row wrap>
                <v-col cols="12" md="6" sm="6">
                  ...
                  <v-select
                    ...
                    dense
                    v-model="editedItem.case_categores_id"
                    required
                    label=" نوع الحاله "
                  ...
                  <v-flex xs12>
                    <v-simple-table style="direction: ltr !important">
                      <template v-slot:default>
                        ...
                        <tbody>
                          <tr
                            v-for="(row, rowIndex) in editedItem.root_stuffing
                              .access_opening"
                            :key="rowIndex"
                          >
                      ...
                      <template v-slot:default>
                        <thead>
                          <tr>
                            ...
                            <th>Last file size</th>

                            <th>Sealer Type & duration</th>

                            <th>Gutta percha size</th>
                        ...
                        <tbody>
                          ...
                          >
                            ...
                            <td style="padding: 0px">
                              <v-icon
                                style="color: red"
                                @click="deletoburationerow(rowIndex)"
                                v-bind="attrs"
                                v-on="on"
                              >
                                mdi-delete</v-icon
              ...
              <v-row
                row
                wrap
                v-for="(note, index) in editedItem.sessions"
                :key="note"
              >
                <v-col cols="12" md="2">
                ...
                >
                  <v-textarea
                    v-model="editedItem.sessions[index].note"
                    outlined
                    name="input-7-1"
                ...
                <v-col
                  cols="12"
                  md="2"
                  v-if="editedItem.sessions[index].date == ''"
                >
                ...
                <v-col cols="12" md="2" v-else>
                  <p :class="$vuetify.breakpoint.xs ? 'onl_ph_datea' : ''">
                    {{
                      new Date(editedItem.sessions[index].date)
              ...
              <v-row row wrap v-if="editedItem.images.length > 0">
                <v-col
                  cols="12"
                  md="4"
                  v-for="(img, index) in editedItem.images"
                  :key="img"
                  pr-2
                  pl-2
                >
                  <div style="height: auto; width: auto">
                    ...
                    <div class="images-wrapper">
                      <div
                        class="image"
                        v-for="(image, imageIndex) in editedItem.images"
                        :key="imageIndex"
                    ...
                    <div style="position: relative; width: 100%; height: 100%">
                      ...
                      <span
                        v-if="img.image_url !== undefined"
                        @click="deleteImage(index, img.id)"
                        style="
                          position: absolute;
                          top: 5px;
                          right: 5px;
            ...
            <v-card class="cre_bill">
              <v-layout row wrap>
                ...
                <v-flex md2>
                  <p class="se_tit_menu">الفاتوره</p>
                </v-flex>
              ...
              <v-layout
                row
                wrap
                v-for="(item, index) in editedItem.bills"
                :key="index"
              >
                ...
                <v-flex md="4" md4 xs6>
                  <v-text-field
                    suffix="IQ"
                    dense
                    v-model="editedItem.bills[index].price"
                    type="number"
                    label="الملغ المدفوع"
                    outlined
                  >
                ...
                <v-flex md4 xs5>
                  <v-menu
                    v-model="menu[editedItem.bills.indexOf(item)]"
                  ...
                  >
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        ...
                        outlined
                        @blur="
                          date = parseDate(editedItem.bills[index].PaymentDate)
                        "
                        v-model="editedItem.bills[index].PaymentDate"
                        label="التاريخ"
                ...
                <v-flex xs1 md1>
                  <v-icon
                    style="color: red"
                    @click="deletePayment(index, item.id)"
                    v-bind="attrs"
                    v-on="on"
                  >
                    mdi-delete</v-icon
