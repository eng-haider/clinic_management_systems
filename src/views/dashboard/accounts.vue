        ...
        <template v-slot:top>
          ...
          <v-container id="dashboard" fluid>
            <v-layout row wrap>
              ...
              <v-flex
                ...
                pl-3
                v-if="
                  $store.state.AdminInfo.Permissions.includes(
                    'show_all_clinic_doctors',
                  ) && doctorsAll.length > 2
                "
              >
                <v-select
                  dense
                  v-model="search.DocorId"
                  :label="$t('doctor')"
                  :items="doctorsAll"
                  outlined
                  item-text="name"
              ...
              <v-flex xs2 md1 sm1 pt-2 v-if="showSalaryDeliveryButton">
                <v-btn
                  ...
                  dense
                  style="color: #fff"
                  @click="openSalaryDeliveryDialog()"
                >
          ...
          <v-layout row wrap pt-4 pb-4>
              ...
              <v-card class="mx-auto" outlined>
                <v-card-text>
                  <div class="text-center">
                    <v-icon large color="#035aa6"
                      >fa-solid fa-money-bill</v-icon
                    >
                    <div
                    ...
                    <div v-if="showDoctorPercentage" class="mt-2">
                      ...
                      >
                        {{
                          (accounts_statistic.all_sum -
                            (accounts_statistic.item_cost_sum *
                              doctorPercentage) /
                              100)
                            | currency
                        }}
              ...
              <v-card class="mx-auto" outlined>
                <v-card-text>
                  <div class="text-center">
                    ...
                    <div class="text-h5 font-weight-bold mt-1">
                      {{
                        (accounts_statistic.all_sum - accounts_statistic.paid)
                          | currency
                      }}
                    </div>
                    <div v-if="showDoctorPercentage" class="mt-2">
            ...
            <v-flex
              ...
              pb-4
              pt-4
              v-if="$store.getters.useCreditSystem"
            >
              <v-card class="mx-auto" outlined>
                <v-card-text>
                  <div class="text-center">
          ...
          <v-layout row wrap pt-4 mb-4 style="margin-bottom: 20px">
            ...
            <v-flex xs12 md3 sm6 pr-2 pb-4>
              <dash_card
                ...
                text_color="#53D3F8"
                icon_color="#035aa6"
                :count="accounts_statistic.paid | currency"
              ></dash_card>
            </v-flex>
            ...
            <v-flex xs12 md3 sm6 pr-2 pb-4>
              <dash_card
                ...
                text_color="#53D3F8"
                icon_color="#035aa6"
                :count="accounts_statistic.remainingamount"
              ></dash_card>
            </v-flex>
            <v-flex xs12 md3 sm6 pr-2 pb-4>
              <dash_card
                ...
                text_color="#53D3F8"
                icon_color="#035aa6"
                :count="accounts_statistic.Conjugationsprice"
              ></dash_card>
            </v-flex>
          </v-layout>
      ...
      <v-layout row wrap>
        <v-flex xs12>
          <div class="text-center pt-2">
            <v-pagination
              v-model="page"
              prev-icon="fas fa-angle-left fa-lg"
              color="#c7000b"
              next-icon="fas fa-angle-right fa-lg"
        ...
        <v-card-text class="pt-4">
          <div class="doctor-info mb-3">
            <p class="subtitle-1 mb-1">
              ...
              {{ selectedDoctorData ? selectedDoctorData.name : "" }}
            </p>
          </div>
...
export default {
  ...
  computed: {
    ...
    doctorPercentage() {
      ...
      return doctorMoney && !isNaN(doctorMoney)
        ? parseFloat(doctorMoney)
        : null;
    },
    ...
    doctorRemainingAmount() {
      if (!this.showDoctorPercentage) return 0;
      const remaining =
        this.accounts_statistic.all_sum - this.accounts_statistic.paid;
  ...
  watch: {
    ...
    "search.DocorId": function (newVal) {
      if (newVal && newVal !== 0) {
        this.selectedDoctorData = this.doctorsAll.find(
          (doctor) => doctor.id === newVal,
        );
      } else {
  ...
  methods: {
    getByDocor() {
      ...
      this.axios
        .get(
          "https://mina-api.tctate.com/api/patientsAccounstsv2/getByDoctor/" +
            this.searchDocorId,
          {
            headers: {
    ...
    Export() {
      this.axios
        .get("https://mina-api.tctate.com/api/patientsAccounstsv2/export", {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: "Bearer " + this.$store.state.AdminInfo.token,
    ...
    editItem(item) {
      ...
      const patientData =
        item.patient || item.billable?.patient || item.billable || item;
    ...
    getDoctorName(item) {
      ...
      if (
        item.billable &&
        item.billable.doctors &&
        item.billable.doctors.length > 0
      ) {
    ...
    initialize() {
      ...
      if (this.is_search == true) {
        ...
        this.axios
          .post(
            "https://mina-api.tctate.com/api/patientsAccounstsv2?page=" +
              this.current_page,
            this.search,
            {
              headers: {
    ...
    getAccountsReport() {
      ...
      if (this.is_search) {
        ...
        this.axios
          .post(
            "https://mina-api.tctate.com/api/patientsAccounstsv2/patientsAccounstsReportv2?page=1",
            this.search,
            {
              headers: {
                "Content-Type": "application/json",
          ...
          .then((res) => {
            ...
            this.accounts_statistic.Conjugationsprice =
              res.data.Conjugationsprice;
            this.accounts_statistic.total_credit_balance =
              res.data.total_credit_balance || 0;
    ...
    getclinicDoctor() {
      ...
      this.axios
        .get("https://mina-api.tctate.com/api/doctors/clinic", {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: "Bearer " + this.$store.state.AdminInfo.token,
    ...
    getCase_number_stats() {
      this.axios
        .get(
          "https://mina-api.tctate.com/api/cases/getCaseCategoriesCounts",
          {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
    ...
    openSalaryDeliveryDialog() {
      ...
      this.salaryDeliveryDate = new Date(
        Date.now() - new Date().getTimezoneOffset() * 60000,
      )
        .toISOString()
        .substr(0, 10);
    ...
    async setSalaryDeliveryDate() {
      ...
      try {
        await this.axios.post(
          "https://mina-api.tctate.com/api/doctorss/setSalaryDeliveryDate",
          {
