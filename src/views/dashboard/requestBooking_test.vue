    ...
    return `${formattedHours}:${minutes.toString().padStart(2, '0')} ${period}`;
      ...
      async save() {
        if (this.$refs.form.validate()) {
          ...
          try {
            ...
            const response = await axios.post('https://hasan.tctate.com/api/reservations', reservationData, {
              headers: {
                "Content-Type": "application/json",
                Accept: "application/json",
                Authorization: "Bearer " + this.$store.state.AdminInfo.token,
            ...
            if (  this.editedItem.appointmentMessage && this.patient) {
              try {
                ...
                const whatsappResponse = await axios.post('https://hasan.tctate.com/api/whatsapp', whatsappData, {
                  headers: {
                    "Content-Type": "application/json",
                    Accept: "application/json",
                    Authorization: "Bearer " + this.$store.state.AdminInfo.token,
      ...
      async fetchReservations() {
        try {
          ...
          const response = await axios.get('https://hasan.tctate.com/api/reservations/formatted', {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
              Authorization: "Bearer " + this.$store.state.AdminInfo.token,
