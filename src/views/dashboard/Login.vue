  ...
  <div style="height: 100%; direction: rtl">
    <v-layout row wrap style="height: 100%; background-color: #fff">
      <v-flex xs12 md7 sm7 class="pdr">
        <v-card style="padding: 45px" flat>
          <h1 style="text-align: right">
            اهلا وسهلا بكم في منصة العياده الذكية
          </h1>
          <br /><br /><br />
          <div>
              ...
              <v-layout row wrap>
                ...
                <v-flex xs12 md8 sm8>
                  <v-btn
                    ...
                    v-bind:class="{ btn_active: signin }"
                    large
                  >
                    دخول
                  </v-btn>
      ...
      <v-flex xs12 class="hidden-md-and-down" md5 sm5>
        <v-layout
          column
          style="height: 100%; background-color: #3dbfef !important"
        >
          <div
            style="
              height: 100%;
          ...
          >
            ...
            <v-layout row wrap style="padding-top: 40px">
              ...
              <v-flex xs8>
                <v-img
                  class="cvc"
                  src="https://demo.tctate.com/assets/3899624.png"
  ...
  methods: {
    submitSignup() {
      if (this.$refs.form_signin.validate()) {
        ...
        this.axios
          .post(
            "https://mina-api.tctate.com/api/usershttps://mina-api.tctate.com",
            data,
          )
          .then((res) => {
