  ...
  methods: {
    ...
    async initialize() {
      ...
      try {
        ...
        console.log(
          "Token:",
          this.$store.state.AdminInfo.token ? "Present" : "Missing",
        );

        const response = await axios.get(
          "https://mina-api.tctate.com/api/case-categories",
          {
            headers: {
    ...
    async deleteItemConfirm() {
      ...
      try {
        await axios.delete(
          `https://mina-api.tctate.com/api/case-categories/${this.editedItem.id}`,
          {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
