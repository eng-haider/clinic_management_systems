    ...
    export default {
        ...
        methods: {
            ...
            saveCat() {
                ...
                if (this.$refs.form.validate()) {
                    ...
                    if (this.editedCategoryIndex > -1) {
                        ...
                        this.axios
                            .patch("https://mina-api.tctate.com/api/ConjugationsCategories/" + this.editedItemCategories.id, this
                                .editedItemCategories, {
                                    headers: {
                                        "Content-Type": "application/json",
                                        Accept: "application/json",
                        ...
                        this.axios
                            .post("https://mina-api.tctate.com/api/ConjugationsCategories", this.editedItemCategories, {
                                headers: {
                                    "Content-Type": "application/json",
                                    Accept: "application/json",
                                    Authorization: "Bearer " + this.$store.state.AdminInfo.token,
            ...
            save() {
                ...
                if (this.$refs.form.validate()) {
                    ...
                    if (this.editedIndex > -1) {
                        ...
                        this.axios
                            .post("https://mina-api.tctate.com/api/Conjugations", this.editedItem, {
                                headers: {
                                    "Content-Type": "application/json",
                                    Accept: "application/json",
                                    Authorization: "Bearer " + this.$store.state.AdminInfo.token,
            ...
            fetchDataByCategory(categoryId) {
                Axios.get(`https://mina-api.tctate.com/api/Conjugations/getByCat/${categoryId}`, {
                        headers: {
                            "Content-Type": "application/json",
                            Accept: "application/json",
                            Authorization: "Bearer " + this.$store.state.AdminInfo.token
            ...
            updateIsPaid(item) {
                Axios.patch(`https://mina-api.tctate.com/api/Conjugations/updateIsPaid/${item.id}`, {
