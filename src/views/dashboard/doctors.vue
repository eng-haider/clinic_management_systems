    ...
    <v-container id="dashboard" fluid tag="section">
      ...
      >
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col class="py-0" cols="12" sm="6" md="6">
                          <v-text-field
                            v-model="editedItem.profit_percentage"
                            type="number"
                            min="0"
                            max="100"
                            step="0.01"
        ...
        <template v-slot:[`item.profit_percentage`]="{ item }">
          <v-chip
            v-if="
              item.info.profit_percentage !== null &&
              item.info.profit_percentage !== undefined
            "
            small
            color="success"
            text-color="white"
    ...
    return {
      ...
      phoneRules: [
        ...
        (v) =>
          ...
          this.$t("validation.phone_length_doctors"),
        (v) => /^\d+$/.test(v) || this.$t("validation.phone_format"),
      ],
      passwordRules: [
        (v) => !!v || this.$t("validation.password_required"),
        (v) =>
          v.length >= 6 || this.$t("validation.password_min_length_doctors"),
  ...
  methods: {
    save() {
      if (this.$refs.form.validate()) {
        ...
        if (
          this.editedItem.profit_percentage !== null &&
          this.editedItem.profit_percentage !== "" &&
          this.editedItem.profit_percentage !== undefined
        ) {
