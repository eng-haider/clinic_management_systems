  ...
  <div>
    ...
    <v-dialog v-model="RecipeItemDialog" max-width="1000px" persistent>
      <RecipesItems
        ...
        "
        @save="initializeRecipeItems"
        @create="createRecipeItem"
        @update="updateRecipeItem"
        @delete="deleteRecipeItem"
      >
      </RecipesItems>
    </v-dialog>
  ...
  methods: {
    ...
    deleteRecipeItem(item) {
      Swal.fire({
        ...
        if (result.value) {
          Axios.delete(
            "https://mina-api.tctate.com/api/recipes-items/" + item.id,
            {
              headers: {
                "Content-Type": "application/json",
                Accept: "application/json",
    ...
    initializeRecipeItems() {
      this.loading = true;
      Axios.get(
        "https://mina-api.tctate.com/api/recipes-items/getByDoctorId",
        {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
