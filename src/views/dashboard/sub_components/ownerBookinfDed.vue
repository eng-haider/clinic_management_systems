  ...
  export default {
    ...
    methods: {
      ...
      getOwnerItems() {
        ...
        var url = "https://tctate.com/api/api/v2/items/owner/get?page=1";
        this.loading = true
        this.$http({
          method: 'get',
          url: url,
      ...
      getitems() {
        ...
        this.$http({
          method: 'get',
          url: "https://tctate.com/v2/api/items/owner/get?page=" + this.current_page,
          headers: {
...
getOwnerTctateitemsById() {
  ...
  this.loading = true
    ...
    getDate_andTime(id) {
      ...
      var url = this.urL + "https://tctate.com/api/getDaysTime/" + id;
