...
export default {
  ...
  methods: {
    ...
    async loadCaseStats() {
      try {
        const response = await this.axios.get("https://smartclinicv5.tctate.com/api/cases/getCaseCategoriesCounts", {
          headers: {
    ...
    async loadDashboardCounts() {
      try {
        const response = await this.axios.get("https://smartclinicv5.tctate.com/api/cases/getDashbourdCounts", {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
    ...
    async loadAccountsCounts() {
      try {
        const response = await this.axios.get(`https://smartclinicv5.tctate.com/api/patientsAccounsts/dash?page=1`, {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
