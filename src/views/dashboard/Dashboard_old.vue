...
export default {
  ...
  methods: {
    ...
    async loadAccountsCounts() {
      try {
        const response = await this.axios.get(`https://hasan.tctate.com/api/patientsAccounsts/dash?page=1`, {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
  ...
  methods: {
    ...
    getAccountsCounts() {
      ...
      this.axios.get(`https://hasan.tctate.com/api/patientsAccounsts/dash?page=${this.current_page}`, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
    ...
    getDashbourdCounts() {
      this.axios.get("https://hasan.tctate.com/api/cases/getDashbourdCounts", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
