...
export default {
  ...
  methods: {
    ...
    async loadCaseStats() {
      try {
        const response = await this.axios.get("https://smartclinicv3.tctate.com/back/public/api/cases/getCaseCategoriesCounts", {
          headers: {
    ...
    async loadDashboardCounts() {
      try {
        const response = await this.axios.get("https://smartclinicv3.tctate.com/back/public/api/cases/getDashbourdCounts", {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
    ...
    async loadAccountsCounts() {
      try {
        const response = await this.axios.get(`https://smartclinicv3.tctate.com/back/public/api/patientsAccounsts/dash?page=1`, {
          headers: {
            "Content-Type": "application/json",
            Accept: "application/json",
            Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
  ...
  methods: {
    ...
    getAccountsCounts() {
      ...
      this.axios.get(`https://smartclinicv3.tctate.com/back/public/api/patientsAccounsts/dash?page=${this.current_page}`, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
    ...
    getDashbourdCounts() {
      this.axios.get("https://smartclinicv3.tctate.com/back/public/api/cases/getDashbourdCounts", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: `Bearer ${this.$store.state.AdminInfo.token}`
