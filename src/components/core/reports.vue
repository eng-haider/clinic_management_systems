    ...
    methods: {
      ...
      async exportCases() {
        ...
        try {
          ...
          const response = await this.axios.https://titaniumapi.tctate.comcases/export-cases', {
      ...
      initialize() {
        if (this.is_search == true) {
          ...
          this.axios.get('https://titaniumapi.tctate.com/api/patientsAccounsts?page=' + this.current_page, {
              headers: {
                "Content-Type": "application/json",
                Accept: "application/json",
                Authorization: "Bearer " + this.$store.state.AdminInfo.token
