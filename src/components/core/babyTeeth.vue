<template>
  <div>
    ...
    C72.3,110.2,73.9,111.2,75.6,111.7z" />
              ...
              <g>
                <path class="comon st2" @click="reply_click(53, $event)" @contextmenu.prevent="right_click(53, $event)" @touchstart="reply_click(53, $event)"
                  :class="[tooth_num.includes(53) ?  'activeClass comon st3' : 'comon st3']" id="53"
            ...
            <a href="#">
              <g>
                <path @click="reply_click(51, $event)" @contextmenu.prevent="right_click(51, $event)" @touchstart="reply_click(51, $event)"
                  :class="[tooth_num.includes(51) ?  'activeClass comon st3' : 'comon st3']" id="51"
        ...
        c-4,0.7-8.2,1.4-12.3,0.7c-3.7-0.5-7.5-0.1-10.9-1.9c-0.8-4.6-0.1-9.4-0.4-14.1C210.9,28,215.4,18.2,224.1,14.8z" />
                <path @click="reply_click(61, $event)" @contextmenu.prevent="right_click(61, $event)" @touchstart="reply_click(61, $event)"
                  :class="[tooth_num.includes(61) ?  'activeClass comon st3' : 'comon st4']" id="61" d="M250,14.7c3.3-0.9,6.5,1,8.8,3c5.5,4.7,8,12.1,8,19.3c-0.1,4.4,0.1,8.8-0.1,13.2c-2,2.8-6.1,2.1-9.1,2.5
        c-5,0.8-10.2,0.5-15.1-0.7c-2.8-1.6-2.3-5.3-2.4-8c0.3-7.7-1.3-16.2,3.1-23.2C244.9,18.2,246.9,15.4,250,14.7z" />
                <path @click="reply_click(83,$event)" @contextmenu.prevent="right_click(83, $event)"
                  :class="[tooth_num.includes(83) ?  'activeClass comon st5' : 'comon st5']" id="83"
        ...
        c-5.8-2-10.5-6.8-12.3-12.6c0-4.3-1.2-9.1,1.4-12.9C156.7,106.7,160,103.8,163.9,102.6z" />
                <path @click="reply_click(82,$event)" @contextmenu.prevent="right_click(82, $event)"
                  :class="[tooth_num.includes(82) ?  'activeClass comon st5' : 'comon st6']" id="82"
        ...
        c-1,3.4-4.6,5.1-7.7,6.2c-5.1,0.9-10.3-1.9-13.4-5.9c-4.1-5.8-2.8-13.2-2.9-19.8C184.4,104.4,189,104.8,192.5,104.1z" />
                <path @click="reply_click(81,$event)" @contextmenu.prevent="right_click(81, $event)"
                  :class="[tooth_num.includes(81) ?  'activeClass comon st7' : 'comon st7']" id="81"
            ...
            <a href="#">
              <g>
                <path class="comon st8" @click="reply_click(63, $event)" @contextmenu.prevent="right_click(63, $event)"
                  :class="[tooth_num.includes(63) ?  'activeClass comon st3' : 'comon st3']" id="63" d="M304.6,16.2c3.9-3.4,9.8-3.2,13.6,0.3c7.3,5.4,7,15.5,6.8,23.6c-2.3,4.9-6,9.1-11,11.3
        c-3.1,1.2-5.6-1.5-7.8-3.1c-3.3-2.7-6.7-6-7.7-10.2C297.6,30.4,299.2,22,304.6,16.2z" />
                <path class="comon st9" id="54" @click="reply_click(54, $event)" @contextmenu.prevent="right_click(54, $event)"
        ...
        c-3.1,4.4-8.6,7.8-14.1,6.8c-3.7-0.8-7.6-2.3-10.1-5.3C122.8,34.5,125.3,23.6,133.8,18.4z" />
                ...
                <path class="comon st10" id="52" @click="reply_click(52, $event)" @contextmenu.prevent="right_click(52, $event)"
        ...
        c-5.3,3.3-11.8,3.4-17.8,2.6c-3.2-0.5-6.2-1.9-8.4-4.2C182.9,39,180.5,31.7,184.3,25.8z" />
                ...
                <path class="comon st11" id="64" @click="reply_click(64, $event)" @contextmenu.prevent="right_click(64, $event)"
        ...
        c-3-1.6-4.9-4.5-6.9-7.2c0.1-3.2-0.5-6.5,0.4-9.6C330.3,25.5,333.5,20.6,338.5,18.1z" />
                <path class="comon st12" id="62" @click="reply_click(62, $event)" @contextmenu.prevent="right_click(62, $event)"
        ...
        c-6.4,1.3-13.4,1.2-19.2-2.1C269.3,40.4,268.6,33.1,270.7,26.4z" />
                <path class="comon st13" id="84" @click="reply_click(84 ,$event)" @contextmenu.prevent="right_click(84, $event)"
                  :class="[tooth_num.includes(84) ?  'activeClass comon st3' : 'comon st3']" d="M131.1,106c6.1-3.2,13.9-0.8,17.4,5c2.5,2.4,1.8,5.9,1.9,9c0.4,4-2.5,7.2-4.9,10c-3,3.5-8.5,5-12.6,2.3
        c-4.1-3-8.4-6.9-8.8-12.3c0-3.1-0.8-6.6,0.9-9.5C126.7,108.5,128.9,107,131.1,106z" />
                <path class="comon st14" id="74" @click="reply_click(74,$event)" @contextmenu.prevent="right_click(74, $event)"
                  :class="[tooth_num.includes(74) ?  'activeClass comon st3' : 'comon st3']"
            ...
            <a href="#">
              <g>
                <path class="comon st15" @click="reply_click(55, $event)" @contextmenu.prevent="right_click(55, $event)"
                  :class="[tooth_num.includes(55) ?  'activeClass comon st3' : 'comon st3']" id="55"
        ...
        c-2.3,3.4-6.4,4.9-10.1,6c-2.8,1-5.7,0-8.5-0.4c-2.6-1.1-5.3-2.2-7.4-4.1C94.4,37.3,94.5,30.1,99.3,25.8z" />
                <path class="comon st16" id="65" @click="reply_click(65, $event)" @contextmenu.prevent="right_click(65, $event)"
        ...
        C443.6,37.5,443.4,30.2,448.5,25.9z" />
                <path class="comon st19" id="73" @click="reply_click(73,$event)" @contextmenu.prevent="right_click(73, $event)"
                  :class="[tooth_num.includes(73) ?  'activeClass comon st3' : 'comon st3']" d="M298.4,114.8c3-4.8,7.3-9.2,12.3-11.9c2.5-1.4,5.2,0.1,7.3,1.5c3.2,2,5.3,5.2,7,8.4c-0.3,4.4,1,9.3-1.4,13.3
        c-2.3,4-5.9,7.3-10.1,9.1c-3.3,1.4-7.6,0.8-10-2.1C298.8,128.3,298.1,121.2,298.4,114.8z" />
                <path class="comon st20" id="85" @click="reply_click(85, $event)" @contextmenu.prevent="right_click(85, $event)"
                  :class="[tooth_num.includes(85) ?  'activeClass comon st3' : 'comon st3']" d="M106.7,104.3c5.4-0.9,10.7,2.8,13.6,7.2c1.5,1.8,1,4.4,1,6.5c-0.1,5.3-3.9,9.7-8,12.7
        c-2.7,2.6-7.3,2.7-10.3,0.6c-3.4-2.1-6.4-5-8-8.7c-0.4-3.4-0.3-6.9-0.1-10.3C97.1,107.8,102,105.3,106.7,104.3z" />
                <path class="comon st21" id="75" @click="reply_click(75,$event)" @contextmenu.prevent="right_click(75, $event)"
                  :class="[tooth_num.includes(75) ?  'activeClass comon st3' : 'comon st3']" d="M366,104.8c6.2-2,13.4,1.7,16.8,7c0.7,3.5,0.4,7.2,0.2,10.8c-2,4.5-5.9,8.2-10.4,10
            ...
            <a href="#">
              <g>
                <path class="comon st22" id="26" @click="reply_click(26, $event)" @contextmenu.prevent="right_click(26, $event)"
                  :class="[tooth_num.includes(26) ?  'activeClass comon st3' : 'comon st3']" d="M390.3,24c2.7-3.6,7.9-4.2,11.9-2.9c4.4,2,7,6.5,8.5,10.9c2,4.9,1,10.3,1.2,15.5c-3.8,1.4-8,1.3-11.3-1.3
            ...
            <a href="#">
              <g>
                <path class="comon st25" id="27" @click="reply_click(27, $event)" @contextmenu.prevent="right_click(27, $event)"
                  :class="[tooth_num.includes(27) ?  'activeClass comon st3' : 'comon st3']" d="M420.2,24.7c5.6-0.9,12.9-2.4,17,2.7c2.5,4.1,4.3,8.8,4.2,13.6c-0.3,1.3,0.6,3.5-1,4.1
        c-8.1,3.1-17,2.3-25.4,1.2C415,39.1,412.9,29.3,420.2,24.7z" />
            ...
            <a href="#">
              <g>
                ...
                <path class="comon st26" id="71" @click="reply_click(71,$event)" @contextmenu.prevent="right_click(71, $event)"
                  :class="[tooth_num.includes(71) ?  'activeClass comon st3' : 'comon st3']" d="M240.2,105c8.6-2.5,18-2.1,26.5,0.6c0,3.5,0,6.9,0,10.4c-2,7-5.6,14.3-12.4,17.6c-2.9,1.8-6.4,0.2-8.6-1.9
            ...
            <a href="#">
              <g>
                <path class="comon st28" @click="reply_click(38, $event)" @contextmenu.prevent="right_click(38, $event)"
                  :class="[tooth_num.includes(38) ?  'activeClass comon st3' : 'comon st3']"
    ...
    C448.5,116.6,448.2,115.9,448,115.2z" />
          ...
          <a href="#">
            <g>
              <path class="comon st31" @click="reply_click(72,$event)" @contextmenu.prevent="right_click(72, $event)"
                :class="[tooth_num.includes(72) ?  'activeClass comon st3' : 'comon st3']" id="72"
            ...
            <a href="#">
              <g>
                <path class="comon st32" @click="reply_click(46, $event)" @contextmenu.prevent="right_click(46, $event)"
                  :class="[tooth_num.includes(46) ?  'activeClass comon st3' : 'comon st3']"
            ...
            <a href="#">
              <g>
                <path class="comon st33" @click="reply_click(36, $event)" @contextmenu.prevent="right_click(36, $event)"
                  :class="[tooth_num.includes(36) ?  'activeClass comon st3' : 'comon st3']"
                  id="36"
          ...
          <a href="#">
            <g>
              ...
              <path class="comon st34" @click="reply_click(47, $event)" @contextmenu.prevent="right_click(47, $event)"
                :class="[tooth_num.includes(47) ?  'activeClass comon st3' : 'comon st3']" id="47"
        ...
        c0.4,6.2-3.4,12.3-8.8,15.2c-4.7,1.7-9.4-1.2-12.8-4.3C38,123.9,36,118.5,36.7,113.1z" />
              <path class="comon st35" @click="reply_click(37, $event)" @contextmenu.prevent="right_click(37, $event)"
                :class="[tooth_num.includes(37) ?  'activeClass comon st3' : 'comon st3']" id="37"
            ...
            <a href="#">
              <g>
                <path class="comon st36" @click="reply_click(48, $event)" @contextmenu.prevent="right_click(48, $event)"
                  :class="[tooth_num.includes(48) ?  'activeClass comon st3' : 'comon st3']"
        ...
        c6.3-2.1,11.9-6.3,14.9-12.3C329.8,131.3,334.9,136.7,341.6,135.9z" />
          ...
          <text transform="matrix(1 0 0 1 114.6549 75)" :class="['st39', 'st40', textClass]">55</text>
          <text transform="matrix(1 0 0 1 144.7977 75)" :class="['st39', 'st40', textClass]">54</text>
          <text transform="matrix(1 0 0 1 169.5968 74.9999)" :class="['st39', 'st40', textClass]">53</text>
          <text transform="matrix(1 0 0 1 198.8225 74.9999)" :class="['st39', 'st40', textClass]">52</text>
          <text transform="matrix(1 0 0 1 229.3609 74.9999)" :class="['st39', 'st40', textClass]">51</text>
          <text transform="matrix(1 0 0 1 256.9392 75)" :class="['st39', 'st40', textClass]">61</text>
          <text transform="matrix(1 0 0 1 286.082 75)" :class="['st39', 'st40', textClass]">62</text>
          <text transform="matrix(1 0 0 1 316.4399 73.0106)" :class="['st39', 'st40', textClass]">63</text>
          <text transform="matrix(1 0 0 1 343.2068 73.0106)" :class="['st39', 'st40', textClass]">64</text>
          <text transform="matrix(1 0 0 1 373.6457 73.0106)" :class="['st39', 'st40', textClass]">65</text>
          ...
          <text transform="matrix(1 0 0 1 114.6549 94.4892)" :class="['st39', 'st40', textClass]">85</text>
          <text transform="matrix(1 0 0 1 144.7977 95.0126)" :class="['st39', 'st40', textClass]">84</text>
          <text transform="matrix(1 0 0 1 169.5968 94.4892)" :class="['st39', 'st40', textClass]">83</text>
          <text transform="matrix(1 0 0 1 198.8225 94.4891)" :class="['st39', 'st40', textClass]">82</text>
          <text transform="matrix(1 0 0 1 229.3609 94.489)" :class="['st39', 'st40', textClass]">81</text>
          <text transform="matrix(1 0 0 1 256.9392 94.4892)" :class="['st39', 'st40', textClass]">71</text>
          <text transform="matrix(1 0 0 1 316.4399 94.4892)" :class="['st39', 'st40', textClass]">73</text>
          <text transform="matrix(1 0 0 1 286.082 95.0127)" :class="['st39', 'st40', textClass]">72</text>
          <text transform="matrix(1 0 0 1 343.2068 95.0127)"   :class="['st39', 'st40', textClass]">74</text>
          <text transform="matrix(1 0 0 1 373.6457 95.5)"  :class="['st39', 'st40', textClass]" >75</text>
