    ...
    C72.3,110.2,73.9,111.2,75.6,111.7z" />
              ...
              <g>
                <path class="comon st2" @click="reply_click(3, $event)" @contextmenu.prevent="right_click(3, $event)" @touchstart="reply_click(3, $event)"
                  :class="[tooth_num.includes(3) || selectedTeeth.includes(3) ?  'activeClass comon st3' : 'comon st3']" id="13"
            ...
            <a href="#">
              <g>
                <path @click="reply_click(5, $event)" @contextmenu.prevent="right_click(5, $event)" @touchstart="reply_click(5, $event)"
                  :class="[tooth_num.includes(5) || selectedTeeth.includes(5) ?  'activeClass comon st3' : 'comon st3']" id="11"
        ...
        c-4,0.7-8.2,1.4-12.3,0.7c-3.7-0.5-7.5-0.1-10.9-1.9c-0.8-4.6-0.1-9.4-0.4-14.1C210.9,28,215.4,18.2,224.1,14.8z" />
                <path @click="reply_click(6, $event)" @contextmenu.prevent="right_click(6, $event)" @touchstart="reply_click(6, $event)"
                  :class="[tooth_num.includes(6) || selectedTeeth.includes(6) ?  'activeClass comon st3' : 'comon st4']" id="21" d="M250,14.7c3.3-0.9,6.5,1,8.8,3c5.5,4.7,8,12.1,8,19.3c-0.1,4.4,0.1,8.8-0.1,13.2c-2,2.8-6.1,2.1-9.1,2.5
        c-5,0.8-10.2,0.5-15.1-0.7c-2.8-1.6-2.3-5.3-2.4-8c0.3-7.7-1.3-16.2,3.1-23.2C244.9,18.2,246.9,15.4,250,14.7z" />
                <path @click="reply_click(13, $event)" @contextmenu.prevent="right_click(13, $event)"
                  :class="[tooth_num.includes(13) || selectedTeeth.includes(13) ?  'activeClass comon st5' : 'comon st5']" id="43"
        ...
        c-5.8-2-10.5-6.8-12.3-12.6c0-4.3-1.2-9.1,1.4-12.9C156.7,106.7,160,103.8,163.9,102.6z" />
                <path @click="reply_click(14, $event)" @contextmenu.prevent="right_click(14, $event)"
                  :class="[tooth_num.includes(14) || selectedTeeth.includes(14) ?  'activeClass comon st5' : 'comon st6']" id="42"
        ...
        c-1,3.4-4.6,5.1-7.7,6.2c-5.1,0.9-10.3-1.9-13.4-5.9c-4.1-5.8-2.8-13.2-2.9-19.8C184.4,104.4,189,104.8,192.5,104.1z" />
                <path @click="reply_click(15, $event)" @contextmenu.prevent="right_click(15, $event)"
                  :class="[tooth_num.includes(15) || selectedTeeth.includes(15) ?  'activeClass comon st7' : 'comon st7']" id="41"
            ...
            <a href="#">
              <g>
                <path class="comon st8" @click="reply_click(8, $event)" @contextmenu.prevent="right_click(8, $event)"
                  :class="[tooth_num.includes(8) || selectedTeeth.includes(8) ?  'activeClass comon st3' : 'comon st3']" id="23" d="M304.6,16.2c3.9-3.4,9.8-3.2,13.6,0.3c7.3,5.4,7,15.5,6.8,23.6c-2.3,4.9-6,9.1-11,11.3
        c-3.1,1.2-5.6-1.5-7.8-3.1c-3.3-2.7-6.7-6-7.7-10.2C297.6,30.4,299.2,22,304.6,16.2z" />
                <path class="comon st9" id="14" @click="reply_click(2, $event)" @contextmenu.prevent="right_click(2, $event)"
                  :class="[tooth_num.includes(2) || selectedTeeth.includes(2) ?  'activeClass comon st3' : 'comon st3']" d="M133.8,18.4c2.1-1.6,4.8-1,6.8,0.4c4.4,2.9,7.4,7.5,9.6,12.2c0.3,3.7,1.3,8.3-1.6,11.3
        c-3.1,4.4-8.6,7.8-14.1,6.8c-3.7-0.8-7.6-2.3-10.1-5.3C122.8,34.5,125.3,23.6,133.8,18.4z" />
                ...
                <path class="comon st10" id="12" @click="reply_click(4, $event)" @contextmenu.prevent="right_click(4, $event)"
                  :class="[tooth_num.includes(4) || selectedTeeth.includes(4) ?  'activeClass comon st3' : 'comon st3']" d="M184.3,25.8c3.6-5.1,10.4-8.2,16.6-6c3.9,1.9,7,5.6,7.4,10.1c0.4,5.8,0.3,11.6,0.1,17.3
        c-5.3,3.3-11.8,3.4-17.8,2.6c-3.2-0.5-6.2-1.9-8.4-4.2C182.9,39,180.5,31.7,184.3,25.8z" />
                ...
                <path class="comon st11" id="24" @click="reply_click(9, $event)" @contextmenu.prevent="right_click(9, $event)"
                  :class="[tooth_num.includes(9) || selectedTeeth.includes(9) ?  'activeClass comon st3' : 'comon st3']" d="M338.5,18.1c3.2-1.9,6.5,0.8,8.8,3c5.9,5.9,7.6,14.9,6.1,22.8c-4.6,5.1-13.1,7.4-19.1,3.4
        c-3-1.6-4.9-4.5-6.9-7.2c0.1-3.2-0.5-6.5,0.4-9.6C330.3,25.5,333.5,20.6,338.5,18.1z" />
                <path class="comon st12" id="22" @click="reply_click(7, $event)" @contextmenu.prevent="right_click(7, $event)"
                  :class="[tooth_num.includes(7) || selectedTeeth.includes(7) ?  'activeClass comon st3' : 'comon st3']" d="M270.7,26.4c2.9-8.1,14.4-9.4,20.2-3.7c6.6,4.7,4.8,13.3,5,20.2c0.8,4.1-3.8,5.5-6.8,6.5
        c-6.4,1.3-13.4,1.2-19.2-2.1C269.3,40.4,268.6,33.1,270.7,26.4z" />
                <path class="comon st13" id="44" @click="reply_click(12, $event)" @contextmenu.prevent="right_click(12, $event)"
                  :class="[tooth_num.includes(12) || selectedTeeth.includes(12) ?  'activeClass comon st3' : 'comon st3']" d="M131.1,106c6.1-3.2,13.9-0.8,17.4,5c2.5,2.4,1.8,5.9,1.9,9c0.4,4-2.5,7.2-4.9,10c-3,3.5-8.5,5-12.6,2.3
        c-4.1-3-8.4-6.9-8.8-12.3c0-3.1-0.8-6.6,0.9-9.5C126.7,108.5,128.9,107,131.1,106z" />
                <path class="comon st14" id="34" @click="reply_click(19, $event)" @contextmenu.prevent="right_click(19, $event)"
                  :class="[tooth_num.includes(19) || selectedTeeth.includes(19) ?  'activeClass comon st3' : 'comon st3']"
            ...
            <a href="#">
              <g>
                <path class="comon st15" @click="reply_click(1, $event)" @contextmenu.prevent="right_click(1, $event)"
                  :class="[tooth_num.includes(1) || selectedTeeth.includes(1) ?  'activeClass comon st3' : 'comon st3']" id="15"
        ...
        c-2.3,3.4-6.4,4.9-10.1,6c-2.8,1-5.7,0-8.5-0.4c-2.6-1.1-5.3-2.2-7.4-4.1C94.4,37.3,94.5,30.1,99.3,25.8z" />
                <path class="comon st16" id="25" @click="reply_click(10, $event)" @contextmenu.prevent="right_click(10, $event)"
                  :class="[tooth_num.includes(10) || selectedTeeth.includes(10) ?  'activeClass comon st3' : 'comon st3']" d="M366.5,20.9c5.2-1.5,9.9,2.5,13.3,5.9c4,4.5,3.5,10.9,3.4,16.5c-5,3.4-11.5,6.3-17.6,4
        c-3.3-1-6.1-2.8-8.7-5.1c0-3.8-0.8-7.9,1.2-11.3C360,27,362.1,22.5,366.5,20.9z" />
                <path class="comon st17" id="16" @click="reply_click(16, $event)" @contextmenu.prevent="right_click(16, $event)"
                  :class="[tooth_num.includes(16) || selectedTeeth.includes(16) ?  'activeClass comon st3' : 'comon st3']" d="M66.3,34.6c1.7-5.5,4.4-11.7,10.1-13.8c3.9-0.9,8.6-0.2,11.2,3.2c2.9,4.1,4.7,9,4.6,14.1
        ...
        C66,43.2,65.4,38.8,66.3,34.6z" />
                <path class="comon st18" id="28" @click="reply_click(28, $event)" @contextmenu.prevent="right_click(28, $event)"
                  :class="[tooth_num.includes(28) || selectedTeeth.includes(28) ?  'activeClass comon st3' : 'comon st3']" d="M448.5,25.9c2.6-2.8,6.6-2.3,10-2.1c4.1,0.6,8.1,2,11.7,4.1c-0.1,4.5,0.4,9.1-0.2,13.6
        ...
        C443.6,37.5,443.4,30.2,448.5,25.9z" />
                <path class="comon st19" id="33" @click="reply_click(18, $event)" @contextmenu.prevent="right_click(18, $event)"
                  :class="[tooth_num.includes(18) || selectedTeeth.includes(18) ?  'activeClass comon st3' : 'comon st3']" d="M298.4,114.8c3-4.8,7.3-9.2,12.3-11.9c2.5-1.4,5.2,0.1,7.3,1.5c3.2,2,5.3,5.2,7,8.4c-0.3,4.4,1,9.3-1.4,13.3
        c-2.3,4-5.9,7.3-10.1,9.1c-3.3,1.4-7.6,0.8-10-2.1C298.8,128.3,298.1,121.2,298.4,114.8z" />
                <path class="comon st20" id="45" @click="reply_click(11, $event)" @contextmenu.prevent="right_click(11, $event)"
                  :class="[tooth_num.includes(11) || selectedTeeth.includes(11) ?  'activeClass comon st3' : 'comon st3']" d="M106.7,104.3c5.4-0.9,10.7,2.8,13.6,7.2c1.5,1.8,1,4.4,1,6.5c-0.1,5.3-3.9,9.7-8,12.7
        c-2.7,2.6-7.3,2.7-10.3,0.6c-3.4-2.1-6.4-5-8-8.7c-0.4-3.4-0.3-6.9-0.1-10.3C97.1,107.8,102,105.3,106.7,104.3z" />
                <path class="comon st21" id="35" @click="reply_click(20, $event)" @contextmenu.prevent="right_click(20, $event)"
                  :class="[tooth_num.includes(20) || selectedTeeth.includes(20) ?  'activeClass comon st3' : 'comon st3']" d="M366,104.8c6.2-2,13.4,1.7,16.8,7c0.7,3.5,0.4,7.2,0.2,10.8c-2,4.5-5.9,8.2-10.4,10
            ...
            <a href="#">
              <g>
                <path class="comon st22" id="26" @click="reply_click(26, $event)" @contextmenu.prevent="right_click(26, $event)"
                  :class="[tooth_num.includes(26) || selectedTeeth.includes(26) ?  'activeClass comon st3' : 'comon st3']" d="M390.3,24c2.7-3.6,7.9-4.2,11.9-2.9c4.4,2,7,6.5,8.5,10.9c2,4.9,1,10.3,1.2,15.5c-3.8,1.4-8,1.3-11.3-1.3
            ...
            <a href="#">
              <g>
                <path class="comon st23" id="18" @click="reply_click(18, $event)" @contextmenu.prevent="right_click(18, $event)"
                  :class="[tooth_num.includes(18) || selectedTeeth.includes(18) ?  'activeClass comon st3' : 'comon st3']" d="M7.7,28c5.3-3.3,11.7-4.9,18-4.1c6,1.6,8.7,8.4,8.3,14.2c-0.3,2.4,0.9,5.6-1.5,7.3c-2.1,1.4-5.4,2-7.4,0.2
            ...
            <a href="#">
              <g>
                <path class="comon st24" id="17" @click="reply_click(17, $event)" @contextmenu.prevent="right_click(17, $event)"
                  :class="[tooth_num.includes(17) || selectedTeeth.includes(17) ?  'activeClass comon st3' : 'comon st3']" d="M40.8,27.4c4.6-5.3,13-4.1,18.8-1.6c5.1,5.5,3.4,13.7,3.5,20.5c-2.2,0.2-4.4,0.4-6.6,0.4l-0.7,0.5
            ...
            <a href="#">
              <g>
                <path class="comon st25" id="27" @click="reply_click(27, $event)" @contextmenu.prevent="right_click(27, $event)"
                  :class="[tooth_num.includes(27) || selectedTeeth.includes(27) ?  'activeClass comon st3' : 'comon st3']" d="M420.2,24.7c5.6-0.9,12.9-2.4,17,2.7c2.5,4.1,4.3,8.8,4.2,13.6c-0.3,1.3,0.6,3.5-1,4.1
            ...
            <a href="#">
              <g>
                ...
                <path class="comon st26" id="31" @click="reply_click(16, $event)" @contextmenu.prevent="right_click(16, $event)"
                  :class="[tooth_num.includes(16) || selectedTeeth.includes(16) ?  'activeClass comon st3' : 'comon st3']" d="M240.2,105c8.6-2.5,18-2.1,26.5,0.6c0,3.5,0,6.9,0,10.4c-2,7-5.6,14.3-12.4,17.6c-2.9,1.8-6.4,0.2-8.6-1.9
            ...
            <a href="#">
              <g>
                <path class="comon st28" @click="reply_click(38, $event)" @contextmenu.prevent="right_click(38, $event)"
                  :class="[tooth_num.includes(38) || selectedTeeth.includes(38) ?  'activeClass comon st3' : 'comon st3']"
    ...
    C448.5,116.6,448.2,115.9,448,115.2z" />
          ...
          <a href="#">
            <g>
              <path class="comon st31" @click="reply_click(17, $event)" @contextmenu.prevent="right_click(17, $event)"
                :class="[tooth_num.includes(17) || selectedTeeth.includes(17) ?  'activeClass comon st3' : 'comon st3']" id="32"
            ...
            <a href="#">
              <g>
                <path class="comon st32" @click="reply_click(46, $event)" @contextmenu.prevent="right_click(46, $event)"
                  :class="[tooth_num.includes(46) || selectedTeeth.includes(46) ?  'activeClass comon st3' : 'comon st3']"
            ...
            <a href="#">
              <g>
                <path class="comon st33" @click="reply_click(36, $event)" @contextmenu.prevent="right_click(36, $event)"
                  :class="[tooth_num.includes(36) || selectedTeeth.includes(36) ?  'activeClass comon st3' : 'comon st3']"
                  id="36"
          ...
          <a href="#">
            <g>
              ...
              <path class="comon st34" @click="reply_click(47, $event)" @contextmenu.prevent="right_click(47, $event)"
                :class="[tooth_num.includes(47) || selectedTeeth.includes(47) ?  'activeClass comon st3' : 'comon st3']" id="47"
        ...
        c0.4,6.2-3.4,12.3-8.8,15.2c-4.7,1.7-9.4-1.2-12.8-4.3C38,123.9,36,118.5,36.7,113.1z" />
              <path class="comon st35" @click="reply_click(37, $event)" @contextmenu.prevent="right_click(37, $event)"
                :class="[tooth_num.includes(37) || selectedTeeth.includes(37) ?  'activeClass comon st3' : 'comon st3']" id="37"
            ...
            <a href="#">
              <g>
                <path class="comon st36" @click="reply_click(48, $event)" @contextmenu.prevent="right_click(48, $event)"
                  :class="[tooth_num.includes(48) || selectedTeeth.includes(48) ?  'activeClass comon st3' : 'comon st3']"
...
.tooth-context-menu {
  background: #fff;
  background: linear-gradient(20deg, #ffffff 0%, #f8fafc 100%);
  border: 1px solid #e2e8f0;
  border-radius: 12px;
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(105, 255, 255, 0.5);
  min-width: 280px;
  max-width: 320px;
  z-index: 1000;
  padding: 0;
...
.menu-header {
  ...
  align-items: center;
  padding: 12px 16px;
  background: linear-gradient(20deg, #1976d2 0%, #1565c0 100%);
  color: white;
  border-bottom: 1px solid rgba(105, 255, 255, 0.2);
}
...
.category-chip:hover {
  ...
  box-shadow: 0 4px 12px rgba(10, 118, 210, 0.3);
}
...
.add-category-section {
  padding: 16px;
  border-top: 1px solid #f1f5f9;
  background: linear-gradient(20deg, #f8fffe 0%, #f0fdf4 100%);
...
.refresh-btn:hover {
  background-color: rgba(10, 118, 210, 0.1) !important;
  transform: translateY(-1px);
}
    ...
    export default {
        ...
        methods: {
            ...
            reply_click(id, event) {
                ...
                // On mobile devices, touch events, or devices with touch capability, show context menu on click
                if (isMobileDevice || isTouchEvent || hasTouch || window.innerWidth <= 768) {
                    event.preventDefault();
                    event.stopPropagation();
                    ...
                    setTimeout(() => {
                        ...
                        // Position menu based on touch position or click position
                        let x = event.clientX || (event.touches && event.touches[0] ? event.touches[0].clientX : event.pageX) || window.innerWidth / 2;
                        let y = event.clientY || (event.touches && event.touches[0] ? event.touches[0].clientY : event.pageY) || window.innerHeight / 2;
            ...
            hideContextMenu(event) {
                ...
                if (event && event.target && event.target.closest && event.target.closest('.tooth-context-menu')) return;
