...
export default {
  ...
  methods: {
    getByDocor() {
      ...
      this.axios
        .get("patientsAccounstsv2/getByDoctor/" + this.searchDocorId, {
          headers: {
    ...
    initialize() {
      ...
      if (this.is_search == true) {
        ...
        this.axios
          .post("/patientsAccounstsv2?page=" + this.current_page, this.search, {
            headers: {
              "Content-Type": "application/json",
              Accept: "application/json",
              Authorization: "Bearer " + this.$store.state.AdminInfo.token,
        ...
        this.axios
          .post(
            "/patientsAccounstsv2?page=" + this.current_page,
            {},
            {
              headers: {
                "Content-Type": "application/json",
    ...
    getAccountsReport() {
      ...
      if (this.is_search) {
        ...
        this.axios
          .post(
            "/patientsAccounstsv2/patientsAccounstsReportv2?page=1",
            this.search,
            {
              headers: {
                "Content-Type": "application/json",
